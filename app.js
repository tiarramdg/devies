function checkHealth() {
    ...
    if ((age >= 18 && age <= 25 && ((sex === 'M' && heartRate >= 62 && heartRate <= 73) || (sex === 'F' && heartRate >= 64 && heartRate <= 80))) ||
        ...
        (age >= 36 && age <= 45 && ((sex === 'M' && heartRate >= 63 && heartRate <= 75) || (sex === 'F' && heartRate >= 65 && heartRate <= 82))) ||
        (age >= 46 && age <= 55 && ((sex === 'M' && heartRate >= 64 && heartRate <= 76) || (sex === 'F' && heartRate >= 66 && heartRate <= 83))) ||
        (age >= 56 && age <= 65 && ((sex === 'M' && heartRate >= 62 && heartRate <= 75) || (sex === 'F' && heartRate >= 64 && heartRate <= 82))) ||
        (age > 65 && ((sex === 'M' && heartRate >= 62 && heartRate <= 73) || (sex === 'F' && heartRate >= 64 && heartRate <= 81)))) {
